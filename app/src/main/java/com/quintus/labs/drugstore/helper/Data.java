package com.quintus.labs.drugstore.helper;

import com.quintus.labs.drugstore.model.Offer;
...
public class Data {
    ...
    public List<Offer> getOfferList() {
        ...
        offerList.add(offer);
        offer = new Offer("https://images-eu.ssl-images-amazon.com/images/G/31/img16/Drug/SVD/July18/750x375.png");
        offerList.add(offer);
        offer = new Offer("https://images-eu.ssl-images-amazon.com/images/G/31/img16/Drug/BreakfastStore/kmande_2018-06-15T12-00_f010a5_1121973_grocery_750x375.jpg");
        offerList.add(offer);
