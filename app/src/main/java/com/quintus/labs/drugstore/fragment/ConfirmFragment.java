...
import com.quintus.labs.drugstore.activity.BaseActivity;
import com.quintus.labs.drugstore.activity.CartActivity;
import com.quintus.labs.drugstore.activity.SuccessActivity;
import com.quintus.labs.drugstore.adapter.CheckoutCartAdapter;
import com.quintus.labs.drugstore.api.clients.RestClient;
import com.quintus.labs.drugstore.model.Cart;
...
import com.quintus.labs.drugstore.util.FilePath;
import com.quintus.labs.drugstore.util.FileUtils;
...
public class ConfirmFragment extends Fragment implements PermissionListener {
    ...
    private void onUploadClicked() {
        final Dialog mDialog = new Dialog(getContext(),R.style.Theme_AppCompat_Dialog_Alert);
    ...
    private void placeUserOrder() {
        ...
        confirmOrder = new PlaceOrder(user.getToken(), user.getFname(), " ", user.getMobile(), user.getCity(), address, user.getId(),prescription_type, orderItemList);
    ...
    private void requestMultiplePermission() {
        ...
        sheriffPermission = Sheriff.Builder()
                ...
                .askFor(SheriffPermission.CAMERA, SheriffPermission.STORAGE)
    ...
    public void onPermissionsDenied(int requestCode, ArrayList<String> deniedPermissionList) {
        Toast.makeText(getContext(), "Permission Denied! Please allow permission to upload image", Toast.LENGTH_LONG).show();
    }

    @Override
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        if (sheriffPermission != null) {
