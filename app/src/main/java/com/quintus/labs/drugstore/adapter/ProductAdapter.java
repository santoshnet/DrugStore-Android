package com.quintus.labs.drugstore.adapter;
...
import com.quintus.labs.drugstore.activity.ProductViewActivity;
import com.quintus.labs.drugstore.interfaces.AddorRemoveCallbacks;
import com.quintus.labs.drugstore.model.Cart;
import com.quintus.labs.drugstore.model.Product;
        ...
        holder.plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cartList.size() == 0 || pQuantity == 0) {
                        ...
                        Cart cart = new Cart(product.getId(), product.getName(), product.getImage(), product.getCurrency(), _price, product.getAttribute(), total_item + "", _subtotal);
                        cartList = ((BaseActivity) context).getCartList();
                        cartList.add(cart);
